...
export type ScratchpadEventHandler<K extends ScratchpadEventName> = (data: ScratchpadEvents[K]) => void;
export interface Scratchpad {
    ...
    on<K extends ScratchpadEventName>(event: K, handler: ScratchpadEventHandler<K>): () => void;
    save(): Promise<void>;
    load(): Promise<void>;
